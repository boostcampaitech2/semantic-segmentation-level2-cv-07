...
class UneXt50Enc3(nn.Module):
    def __init__(self, out_channel=11, stride=1, **kwargs):
        ...
        self.aspp = ASPP(1024,256,out_c=256,dilations=[stride*1,stride*2,stride*3])
        ...
        self.fpn = FPN([256,128,64],[16]*3)
        self.drop = nn.Dropout2d(0.1)
        self.final_conv = nn.Conv2d(80, out_channel, kernel_size=(1, 1), stride=stride)
    ...
    def forward(self, x):
        ...
        dec2 = self.dec3(self.drop_aspp(enc5), enc2)
        dec1 = self.dec2(dec2,enc1)
        dec0 = self.dec1(dec1,enc0)
        x = self.fpn([enc5, dec2, dec1], dec0)
